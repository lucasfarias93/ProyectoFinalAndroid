...
public class ImagenActaAsynctask extends AsyncTask<ConnectionParams, Void, List<String>> {
    ...
    public ImagenActaAsynctask(Context context, Callback callback, ProgressDialog dialog, ImageView view) {
    ...
    @Override
    protected void onPostExecute(List<String> result, ImageView view) {
