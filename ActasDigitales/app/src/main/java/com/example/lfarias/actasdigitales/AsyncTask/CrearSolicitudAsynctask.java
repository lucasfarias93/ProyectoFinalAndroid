...
/**
 * Created by lfarias on 10/27/17.
 */

public class CrearSolicitudAsynctask extends AsyncTask<ConnectionParams, Void, List<String>> {
    Context context;
    Callback callback;
    ProgressDialog dialog;

    public CrearSolicitudAsynctask(Context context, Callback callback) {
    ...
    protected void onPostExecute(List<String> result) {
        ...
        switch (searchType) {
            ...
            default:
                ...
                builder.setTitle("Error al crear la solicitud de acta")
                        .setMessage("Ocurrio un error al crear la solicitud de acta. Por favor intente nuevamente mas tarde o contacte al soporte.")
